...
class AccessLogService {
  ...
  fun queryByConditionsIs(conditions: AccessLogQuerySituation): ListResponse<AccessLogVoBean> {
  ...
  fun countByConditionIs(conditions: AccessLogQuerySituation): SingleResponse<Long> {
