...
public class RoleController extends WebApiViewComponent {
  ...
  public BaseResponseVoBean updateRoleDetail(
      @RequestParam( "id" ) String id, @RequestParam( "name" ) String name, @RequestParam( "priority" ) int priority,
    ...
    return roleService.updateRoleDetail( id, name, description, priority, status );
  }
